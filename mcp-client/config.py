...
class StdioServerConfig:
    """Spawn the MCP server as a child process over stdio."""
    command: str                   # e.g. "node"
    args:    List[str]             # e.g. ["server.js", "…"]
...
class SseServerConfig:
    """Talk to the MCP server over HTTP+SSE."""
    url:     str                   # e.g. "http://localhost:3000/nlp"
    headers: Optional[Dict[str,str]] = None
    description: Optional[str]     = None
    enabled:  bool                 = True

# This is the only “MCPServerConfig” you expose to the rest of your code:
